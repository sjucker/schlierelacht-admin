...
public class Keys {
    ...
    public static final UniqueKey<MeetupRegistrationRecord> PK_MEETUP_REGISTRATION = Internal.createUniqueKey(MeetupRegistration.MEETUP_REGISTRATION, DSL.name("pk_meetup_registration"), new TableField[] { MeetupRegistration.MEETUP_REGISTRATION.ID }, true);
    public static final UniqueKey<NewsRecord> PK_NEWS = Internal.createUniqueKey(News.NEWS, DSL.name("pk_news"), new TableField[] { News.NEWS.ID }, true);
